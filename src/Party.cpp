...
void Party::AddPlayer(Client * player)
{
...
bool Party::WithdrawPlayer(Client * player)
{
...
void Party::NotifyMemberList(Client * player) const
{
// 	char * index = packet;
// 
...
void Party::UpdateMemberCoords(Client * player) const
{
...
void Party::UpdateMemberMap(Client * player) const
{
// 	while(Client * member = GetMembers())
// 	{
// 		if(member == player)
...
uint8_t Party::GetAlivePlayerCnt() const
{ 
// 	uint32_t n = 0;
// 
...
Client * Party::GetHuntmasters(Guild * guild)
{
// 	static bool getting = false;
...
Client * Party::GetRaidmasters(Guild * guild)
{
// 	static bool getting = false;
// 	static ClientListCIter iter, end;
// 
...
void Party::PingMap(const Client * pinger, int16_t x, int16_t y, uint32_t pinguid) const
{
// 	foreach(it, _players)
// 	{
// 		Client * player = *it;
