...
public:
	static void Temp();
	static bool bCheckValidName(char *pStr);
	static bool bDecode(char cKey, char *pStr);
	static bool bEncode(char cKey, char *pStr);
	static void GetDirPoint(char cDir, int * pX, int * pY);
